...
st.caption('Upload a leaf image to analyze v1.')
...
if st.sidebar.button('Detect Objects'):
    ...
    # Display detection results and Nitrogen Deficiency Information
    with st.expander("Detection Results"):
        try:
            for box in boxes:
                st.write(box.xywh)
        except Exception as ex:
            st.write("No objects detected or detection failed.")

    # Always display Nitrogen Deficiency Information after detection
