        ...
        if boxes:
            with st.expander("Detection Results"):
                for box in boxes:
                    ...
                    if box.class_name == 'Healthy':  # Compare with 'Healthy'
                        healthy_plant_detected = True

    if healthy_plant_detected:
        st.success("The plant is healthy!")  # Display message if a healthy plant is detected
    else:
        st.write("No healthy plant detected.")
